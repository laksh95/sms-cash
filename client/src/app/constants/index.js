...
export const GET_INITIAL_DATA_DASHBOARD='GET_INITIAL_DATA_DASHBOARD';
...
export const RESET_ERROR_TEACHER = 'RESET_ERROR_TEACHER'
export const RESET_ERROR_SUBJECT = 'RESET_ERROR_SUBJECT'
export const SET_PAGINATION_TEACHER = 'SET_PAGINATION_TEACHER'
